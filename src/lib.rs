...
pub fn get_clock_state(mb: &Mailbox, clock_id: u32) -> Result<u32> {
    use message::clock_state::*;
...
pub fn get_clock_rate(mb: &Mailbox, clock_id: u32) -> Result<u32> {
    use message::clock_rate::*;
